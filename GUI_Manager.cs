...
public class GUI_Manager : MonoBehaviour {
	...
	/*
	 *  This script manages the GUI implementation and all visual 
	 *  and game elements that relate to it. It talks to the GUI_Trigger 
	 *  script in order to know when to activate. Upon activation it will 
	 *  populate the screen with the information prompt and then the fact 
	 *  information along with associated imagery. This include dimming, 
	 *  and blurring the screen, and managing layouts for all bodies of text.
	 */
	...
	//alphas for elements of the gui
	float dimAlpha; //black texture overlay
...
//		Debug.Log("THE TOPIC Y: " + topicText.pixelOffset.y);
	...
	void setGUIElementsValues()
	{
		...
		theIcon = currentKDrop.icon; //get icon from knowledge drop script
		bodyImageCol1 = currentKDrop.bodyImageCol1; //get column 1 body column image from knowledge drop script
		bodyImageCol2 = currentKDrop.bodyImageCol2; //get column 2 body column image from knowledge drop script
	}
